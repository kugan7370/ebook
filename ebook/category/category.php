 ...
 <!-- overview -->
    ...
    <div class="new-releases mt-1  ">
        <div class="new-releases-header mb-3"> 
             <h4 class="text-center font-monospace bg-banner py-3 text-white  rounded text-uppercase "><?php echo $get_cat_title; ?> BOOKS</h4>
        ...
        <div class="owl-carousel owl-theme"">
          ...
          <?php
          $select_post_query="SELECT * FROM posts WHERE post_category='$get_cat_title' ";
